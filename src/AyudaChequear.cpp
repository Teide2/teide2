...
//        this->setGeometry(otro->width()/2 - 5, 35, otro->width()/2, otro->height()-30);
        ...
        QString meta = QDir::toNativeSeparators("/images/panel1.bmp");
        Panel1->setPixmap(QPixmap(start+meta));
        ...
        meta = QDir::toNativeSeparators("/images/panel2.bmp");
        Panel2->setPixmap(QPixmap(start+meta));
        ...
        meta = QDir::toNativeSeparators("/images/panel3.bmp");
        Panel3->setPixmap(QPixmap(start+meta));
        ...
        meta = QDir::toNativeSeparators("/images/panel4.bmp");
        Panel4->setPixmap(QPixmap(start+meta));
